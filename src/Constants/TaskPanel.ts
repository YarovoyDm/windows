...
export const HIDDEN_APPS: Array<string> = [POSTMAN, WEBSTORM, TELEGRAM, STEAM, GOOGLE_CHROME, SKYPE];
...
export const LANGUAGES: Array<LanguagesType> = [
    { abbreviation: UA, title: 'Українська', subTitle: 'Українська (розширена)' },
